@extends('layouts.app')
@section('monitoring_diri','active')
@section('judulmenu','Monitoring Diri')
@section('content')
    ...
    <div class="card-body">
        <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-basic table-condensed datatable-button-init-custom" width="100%" id="log_monitor_table">
                        <thead>
...
<script type="text/javascript">
    ...
    $('#remark_hadir').on('change', function () {
        ...
        $('#log_monitor_table').DataTable().ajax.reload();
    });
    
    $(document).ready(function () {
        $('#log_monitor_table').DataTable({
        dom: 'Bfrtip',
        responsive: true,
        processing: true,
        serverSide: true,
    ...
    var dtable = $('#log_monitor_table').dataTable().api();
    });
    ...
    $('#btnFiterSubmitSearch').click(function(){
         $('#log_monitor_table').DataTable().draw(true);
    }); 
</script>
@endsection